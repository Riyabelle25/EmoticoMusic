package com.example.emoticomusic;
  ...
  /*  public boolean checkPermission() {
    ...
    private class GetEmotionCall extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                URIBuilder builder = new URIBuilder("https://westcentralus.api.cognitive.microsoft.com/face");
                ...
                request.setHeader("Ocp-Apim-Subscription-Key", "bea7a363f45844d5a949643e2e631036");
